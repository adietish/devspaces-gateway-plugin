...
class NamespaceWatchDecisionTest {
    ...
    fun `mixed JetBrains and VS Code namespace is watched`() {
        ...
        val params =
            WorkspaceEditorInfoProvider.getNamespaceWatchDecision("ns", items, emptyMap(), "42")

        assertThat(params).isEqualTo(NamespaceWatchDecision("ns", "42", 1, 2))
    ...
    fun `JetBrains via template only is watched`() {
        ...
        val params =
            WorkspaceEditorInfoProvider.getNamespaceWatchDecision("ns", items, templates, "7")

        assertThat(params).isEqualTo(NamespaceWatchDecision("ns", "7", 1, 1))
        assertThat(params.shouldWatch).isTrue()
    }
